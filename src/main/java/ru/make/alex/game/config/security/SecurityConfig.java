package ru.make.alex.game.config.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/auth/add/player").permitAll()
                        .requestMatchers("/admin/api/**").hasAuthority("SCOPE_adm")
                        .requestMatchers("/user/api/**").hasAuthority("SCOPE_usr")
